...
class QuestionAnsweringTask(LegacyFairseqTask):
    """
    ...
    def setup_task(cls, args, **kwargs):
        ...
        return QuestionAnsweringTask(args, data_dict, label_dict)
    ...
    def load_dataset(self, split, combine=False, **kwargs):
        ...
        start_positions_path = "{}.label".format(get_path("label1", split))
        dataset.update(
            start_positions=RawLabelDataset(
                [
        ...
        end_positions_path = "{}.label".format(get_path("label2", split))
        dataset.update(
            end_positions=RawLabelDataset(
                [
                    parse_position(i, line.strip())
