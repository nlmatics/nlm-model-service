...
@register_model("roberta_span")
class SpanModel(RobertaModel):
...
@register_model_architecture("roberta_span", "roberta_span")
def base_architecture(args):
    roberta_model.base_architecture(args)


@register_model_architecture("roberta_span", "roberta_span_base")
def roberta_span_base_architecture(args):
    roberta_model.roberta_base_architecture(args)


@register_model_architecture("roberta_span", "roberta_span_large")
