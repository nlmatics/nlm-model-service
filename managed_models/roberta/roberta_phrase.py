...
class RobertaPhraseQAResource(RobertaSpanResource):
    """
    Dummy class for better logging
    """

    def __init__(self, *args, **kwargs):
        super().__init__(model_name="PhraseQA", *args, **kwargs)


class RobertaPhraseQAManager(RobertaManager):
    """
    Dummy class for better logging
    """
    ...
    def get_model(self, restart_checkpoint):
        ...
        model = load_span_model(
            f"{base_models_dir}/roberta/roberta.large.phraseqa",
