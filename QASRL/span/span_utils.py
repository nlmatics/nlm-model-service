...
from QASRL.span.mh_ms_question_answering_criterion import mhmsQuestionAnsweringCriterion
from QASRL.span.mh_ms_question_answering_task import mhmsQuestionAnsweringTask
from QASRL.span.mh_ms_span_model import MHMSSpanModel
...
def load_span_model(
    ...
    **kwargs,
    ...
    model = MHMSSpanModel.from_pretrained(
        path,
